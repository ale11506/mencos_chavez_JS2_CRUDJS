...
const getclientes = async () => {
    ...
    const url = `/moran_mejia_IS2_crudjs/controladores/clientes/index.php?cliente_nombre=${nombre}&cliente_apellido=${apellido}&cliente_nit=${nit}&cliente_telefono=${telefono}`
    const config = {
        method: 'GET'
    }
        ...
        if (respuesta.status == 200) {
            ...
            if (data.length > 0) {
                data.forEach(clientes => {
                    ...
                    celda2.innerText = clientes.cliente_nombre;
                    celda3.innerText = clientes.cliente_apellido;
                    celda4.innerText = clientes.cliente_nit;
                    celda5.innerText = clientes.cliente_telefono;
