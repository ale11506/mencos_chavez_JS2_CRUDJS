...
const getClientes = async () => {
    ...
    const url = `/CRUDJS/controladores/clientes/index.php?cli_nombre=${nombre}&cli_apellido=${apellido}&cli_nit=${nit}&cli_telefono=${telefono}`
    const config = {
        method: 'GET'
    }
...
const guardarClientes = async (e) => {
    ...
    const url = '/CRUDJS/controladores/clientes/index.php'
